      ...
      >
        <div>
          <h3 className="text-4xl font-semibold md:text-center">
            <span className="text-gray-100 xl:ml-[8rem] ">About Me</span>
          </h3>
          <p className="text-gray-400 mt-3 md:text-center text-lg xl:ml-[8rem]">
            My knowledge
          </p>
        </div>

        <motion.div className="md:flex md:flex-row   ">
          <motion.div
          ...
          >
            <img
              src={Aboutimg}
              alt=""
              className="w-[20rem] md:w-[25rem]  xl:w-[30rem] h-[40rem] rounded-tl-lg md:rounded-bl-lg rounded-tr-lg"
            />
          </motion.div>
